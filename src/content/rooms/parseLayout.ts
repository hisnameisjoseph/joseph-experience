...
/** Turn ASCII rows ('.' floor, '#' wall, 'D' door, '=' desk, 'R' server rack,
 * 'o' prop base, 'r' rug) into a tile grid. Throws on unknown characters or
 * ragged rows so layout typos fail loudly. */
